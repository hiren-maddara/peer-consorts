...
export default function Testimonials() {
    return (
        <MaxWidthWrapper className="flex flex-col my-20 gap-y-8 overflow-visible h-auto">
            ...
            <div className="grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 h-auto mb-">
